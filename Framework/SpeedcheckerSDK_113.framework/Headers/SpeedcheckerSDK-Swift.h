...
/// The controller manages the speed test process. See also <code>SpeedTestDelegate</code>
...
- (void)startWith:(NSArray<SpeedTestServer *> * _Nonnull)servers completion:(SWIFT_NOESCAPE void (^ _Nonnull)(enum SpeedTestError))completion;
...
/// The set of possible errors occur in the <code>SpeedTestController</code> object.
typedef SWIFT_ENUM(NSInteger, SpeedTestError, closed) {
...
typedef SWIFT_ENUM(NSInteger, SpeedTestLatencyType, closed) {
...
typedef SWIFT_ENUM(NSInteger, SpeedTestNetworkType, closed) {
