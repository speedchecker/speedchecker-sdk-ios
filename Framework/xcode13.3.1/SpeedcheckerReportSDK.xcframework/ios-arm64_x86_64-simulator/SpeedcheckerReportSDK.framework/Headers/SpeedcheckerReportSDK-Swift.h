...
#ifndef SPEEDCHECKERREPORTSDK_SWIFT_H
#define SPEEDCHECKERREPORTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpeedcheckerReportSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC21SpeedcheckerReportSDK18SpeedcheckerReport")
@interface SpeedcheckerReport : NSObject
...
@interface SpeedcheckerReport (SWIFT_EXTENSION(SpeedcheckerReportSDK)) <InternetSpeedTestDelegate>
