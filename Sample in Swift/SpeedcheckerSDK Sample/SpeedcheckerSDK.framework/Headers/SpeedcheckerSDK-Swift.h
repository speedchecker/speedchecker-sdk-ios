...
- (void)startWith:(NSArray<SpeedTestServer *> * _Nonnull)servers completion:(void (^ _Nonnull)(enum SpeedTestError))completion;

/// The function starts a new speed test process.
- (void)start:(void (^ _Nonnull)(enum SpeedTestError))completion;

/// The function finishes the current speed test process.
- (void)forceFinish:(void (^ _Nonnull)(enum SpeedTestError))completion;
